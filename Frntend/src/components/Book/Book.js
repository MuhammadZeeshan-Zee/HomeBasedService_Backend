...
import { message, Spin, Modal } from "antd"; // Import Modal for video
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8">
        <div id="Request-a-quote" className="w-full max-w-lg mx-auto">
          ...
          >
            ...
            {/* <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col">
                <label htmlFor="mapAddress" className="mb-2">
                  Map Address *
                </label>
                <input
                  className="form-input w-full p-2 border border-gray-300 rounded"
                  maxLength="256"
                  name="mapAddress"
                  placeholder="Please drop map location link"
                  type="text"
                  id="mapAddress"
                  required
                  onChange={handleChange}
            ...
            {/* Map Address Field with Validation  */}

          {/* <div className="flex flex-col">
              <label htmlFor="mapAddress" className="mb-2">Map Address *</label>
              <input
                className={`form-input w-full p-2 border ${mapAddressError ? "border-red-500" : "border-gray-300"
                  } rounded`}
                name="mapAddress"
