...
function TermsAndConditions() {
  const termsAndConditions = [
    {
      heading: " Welcome to Service at Door! ",
      description:
    ...
    },
    {
      ...
      lists: [
        " - Ensure the information provided during booking is accurate.",
        "- Make payments promptly through the approved payment methods. ",
    ...
    },
    {
      ...
      description:
        " We reserve the right to update or change these terms at any time. Changes will be posted on this page, and your continued use of service implies acceptance of the updated terms.",
    },
    {
      heading: "Contact Information",
      lists: ["Email: support@serviceatdoor.com", "Phone: +92-123-4567890"],
    },
  ];
  return (
    <>
      ...
      <div className='bg-gray-50 min-h-screen flex flex-col'>
        ...
        <div className='text-center'>
          ...
          <p className='text-lg mt-2'>Effective Date: November 27, 2024</p>
        </div>
        ...
        <div className='flex-grow p-6 md:p-12'>
          <div className='max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8'>
            ...
            <p className='text-neutral-600 mb-4'>
              ...
              the use of Service at Door's Website and Services.
            </p>
            ...
            <p className='text-neutral-600 mt-2'>
              Service at Door provides home services such as cleaning, plumbing,
              electrical maintenance, and other similar offerings. The details
              of each service will be specified at the time of booking.
            </p>
            ...
            <p className='text-neutral-600 mt-2'>
              - Ensure the information provided during booking is accurate.{" "}
              <br /> - Make payments promptly through the approved payment
              methods.
              <br />- Comply with any safety instructions provided by our team.
            </p>
            ...
            <p className='text-neutral-600 mt-2'>
              Service at Door is not liable for any damages or losses incurred
              during or after the provision of services, except as required by
              law.
            </p>
